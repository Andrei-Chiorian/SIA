        ...
        <div class="w-5/6 p-3 pt-5 flex flex-col gap-y-1 bg-gray-300">
            ...
            <form id="afilForm" action="{{route('store')}}" method="post">
                ...
                <div class=" p-3 pl-6 flex flex-col gap-y-3 shadow-inner bg-gray-100 rounded">
                    ...
                    <div class="mt-2 ">
                        <button class="border rounded p-1 px-2 shadow bg-gray-300 hover:bg-gray-400 font-medium" type="submit" name="nuevoUsu" id="nuevoUsu" hidden>Crear Afiliado</button>
                    </div>    
                </div>
            </form>
        </div>
